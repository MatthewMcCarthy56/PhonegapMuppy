...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AddonCalendarNewModule", function() { return AddonCalendarNewModule; });
...
var AddonCalendarNewModule = /** @class */ (function () {
    function AddonCalendarNewModule() {
    }
    AddonCalendarNewModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["J" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_6__newcalendar__["a" /* AddonCalendarNewPage */],
                __WEBPACK_IMPORTED_MODULE_10__calendar_header__["a" /* CalendarHeaderComponent */]
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_7__angular_common__["b" /* CommonModule */],
                __WEBPACK_IMPORTED_MODULE_9_angular_calendar__["c" /* CalendarModule */].forRoot(),
                __WEBPACK_IMPORTED_MODULE_8__angular_router__["a" /* RouterModule */].forChild([{ path: '', component: __WEBPACK_IMPORTED_MODULE_6__newcalendar__["a" /* AddonCalendarNewPage */] }]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* CoreComponentsModule */],
                __WEBPACK_IMPORTED_MODULE_4__directives_directives_module__["a" /* CoreDirectivesModule */],
                __WEBPACK_IMPORTED_MODULE_5__pipes_pipes_module__["a" /* CorePipesModule */],
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_6__newcalendar__["a" /* AddonCalendarNewPage */]),
                __WEBPACK_IMPORTED_MODULE_2__ngx_translate_core__["b" /* TranslateModule */].forChild(),
                __WEBPACK_IMPORTED_MODULE_9_angular_calendar__["c" /* CalendarModule */]
            ],
            exports: [__WEBPACK_IMPORTED_MODULE_6__newcalendar__["a" /* AddonCalendarNewPage */], __WEBPACK_IMPORTED_MODULE_10__calendar_header__["a" /* CalendarHeaderComponent */]]
        })
    ], AddonCalendarNewModule);
    return AddonCalendarNewModule;
}());

//# sourceMappingURL=newcalendar.module.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__providers_helper__ = __webpack_require__(978);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__core_courses_providers_courses__ = __webpack_require__(32);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__components_course_picker_menu_course_picker_menu_popover__ = __webpack_require__(979);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__providers_events__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__providers_app__ = __webpack_require__(9);
...
var AddonCalendarNewPage = /** @class */ (function () {
    function AddonCalendarNewPage(translate, calendarProvider, navParams, domUtils, coursesProvider, utils, calendarHelper, sitesProvider, localNotificationsProvider, popoverCtrl, eventsProvider, navCtrl, appProvider) {
        var _this = this;
        ...
        this.dots$ = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["w" /* EventEmitter */]();
        this.siteHomeId = sitesProvider.getCurrentSite().getSiteHomeId();
        this.notificationsEnabled = localNotificationsProvider.isAvailable();
        if (this.notificationsEnabled) {
            // Re-schedule events if default time changes.
            this.obsDefaultTimeChange = eventsProvider.on(__WEBPACK_IMPORTED_MODULE_6__providers_calendar__["a" /* AddonCalendarProvider */].DEFAULT_NOTIFICATION_TIME_CHANGED, function () {
                calendarProvider.scheduleEventsNotifications(_this.events);
            }, sitesProvider.getCurrentSiteId());
        }
        this.eventId = navParams.get('eventId') || false;
    }
    AddonCalendarNewPage.prototype.beforeMonthViewRender = function (_a) {
        var body = _a.body;
     ...
     * View loaded.
     */
    AddonCalendarNewPage.prototype.ionViewDidLoad = function () {
        var _this = this;
     ...
     */
    AddonCalendarNewPage.prototype.fetchData = function (refresh) {
        var _this = this;
     ...
     * @return {Promise<any>} Promise resolved when done.
     */
    AddonCalendarNewPage.prototype.fetchEvents = function (refresh) {
        var _this = this;
        if (refresh === void 0) { refresh = false; }
        this.loadMoreError = false;
        return this.calendarProvider.getEventsList(this.daysLoaded, __WEBPACK_IMPORTED_MODULE_6__providers_calendar__["a" /* AddonCalendarProvider */].DAYS_INTERVAL).then(function (events) {
            _this.daysLoaded += __WEBPACK_IMPORTED_MODULE_6__providers_calendar__["a" /* AddonCalendarProvider */].DAYS_INTERVAL;
            if (events.length === 0) {
     ...
     */
    AddonCalendarNewPage.prototype.getFilteredEvents = function () {
     ...
     */
    AddonCalendarNewPage.prototype.shouldDisplayEvent = function (event) {
     ...
     */
    AddonCalendarNewPage.prototype.shouldLoadCategories = function (events) {
     ...
     * @return {Promise<any>} Promise resolved when done.
     */
    AddonCalendarNewPage.prototype.loadCategories = function () {
        var _this = this;
     ...
     */
    AddonCalendarNewPage.prototype.refreshEvents = function (refresher) {
        var _this = this;
        var promises = [];
     ...
     */
    AddonCalendarNewPage.prototype.endsSameDay = function (event) {
     ...
     */
    AddonCalendarNewPage.prototype.openCourseFilter = function (event) {
        var _this = this;
        var popover = this.popoverCtrl.create(__WEBPACK_IMPORTED_MODULE_13__components_course_picker_menu_course_picker_menu_popover__["a" /* CoreCoursePickerMenuPopoverComponent */], {
     ...
     */
    AddonCalendarNewPage.prototype.gotoEvent = function (eventId) {
        this.eventId = eventId;
    };
    /**
     * Page destroyed.
     */
    AddonCalendarNewPage.prototype.ngOnDestroy = function () {
        this.obsDefaultTimeChange && this.obsDefaultTimeChange.off();
    };
    AddonCalendarNewPage.prototype.updateDots = function () {
    ...
    AddonCalendarNewPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-addon-calendar-new',
            changeDetection: __WEBPACK_IMPORTED_MODULE_0__angular_core__["j" /* ChangeDetectionStrategy */].OnPush,template:/*ion-inline-start:"/Users/matthewmccarthy/moodle-re-design-/src/addon/calendar/pages/newcalendar/newcalendar.html"*/'<ion-header>\n    <ion-navbar core-back-button>\n        <ion-title>Calendar</ion-title>\n    </ion-navbar>\n</ion-header>\n\n\n<ion-content>\n    <mwl-demo-utils-calendar-header\n      [(view)]="view"\n      [(viewDate)]="viewDate">\n    </mwl-demo-utils-calendar-header>\n\n    <ng-template #loading>\n        <div class="text-center">\n            <i class="fa fa-spin fa-spinner fa-5x"></i> <br />\n            Loading events...\n        </div>\n    </ng-template>\n\n    <div *ngIf="dots$ | async; else loading; let dots" [ngSwitch]="view">\n      <mwl-calendar-month-view\n        *ngSwitchCase="\'month\'"\n        [viewDate]="viewDate"\n        [events]="dots"\n        [activeDayIsOpen]="false"\n        (eventClicked)="eventClicked($event)"\n        (beforeViewRender)="beforeMonthViewRender($event)">\n      </mwl-calendar-month-view>\n      <mwl-calendar-week-view\n        *ngSwitchCase="\'week\'"\n        [viewDate]="viewDate"\n        [events]="dots"\n        (eventClicked)="eventClicked($event)">\n      </mwl-calendar-week-view>\n      <mwl-calendar-day-view\n        *ngSwitchCase="\'day\'"\n        [viewDate]="viewDate"\n        [events]="dots"\n        (eventClicked)="eventClicked($event)">\n      </mwl-calendar-day-view>\n    </div>\n</ion-content>\n'/*ion-inline-end:"/Users/matthewmccarthy/moodle-re-design-/src/addon/calendar/pages/newcalendar/newcalendar.html"*/,
            providers: [
                {
                    provide: __WEBPACK_IMPORTED_MODULE_1_angular_calendar__["a" /* CalendarDateFormatter */],
                    useClass: __WEBPACK_IMPORTED_MODULE_2__customise_date_formats__["a" /* CustomDateFormatter */]
                },
                {
                    provide: __WEBPACK_IMPORTED_MODULE_1_angular_calendar__["b" /* CalendarEventTitleFormatter */],
                    useClass: __WEBPACK_IMPORTED_MODULE_3__custom_event_title_formatter__["a" /* CustomEventTitleFormatter */]
                }
            ]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_5__ngx_translate_core__["c" /* TranslateService */], __WEBPACK_IMPORTED_MODULE_6__providers_calendar__["a" /* AddonCalendarProvider */], __WEBPACK_IMPORTED_MODULE_4_ionic_angular__["t" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_9__providers_utils_dom__["a" /* CoreDomUtilsProvider */], __WEBPACK_IMPORTED_MODULE_8__core_courses_providers_courses__["a" /* CoreCoursesProvider */], __WEBPACK_IMPORTED_MODULE_10__providers_utils_utils__["a" /* CoreUtilsProvider */],
            __WEBPACK_IMPORTED_MODULE_7__providers_helper__["a" /* AddonCalendarHelperProvider */], __WEBPACK_IMPORTED_MODULE_11__providers_sites__["a" /* CoreSitesProvider */],
            __WEBPACK_IMPORTED_MODULE_12__providers_local_notifications__["a" /* CoreLocalNotificationsProvider */], __WEBPACK_IMPORTED_MODULE_4_ionic_angular__["w" /* PopoverController */],
            __WEBPACK_IMPORTED_MODULE_14__providers_events__["a" /* CoreEventsProvider */], __WEBPACK_IMPORTED_MODULE_4_ionic_angular__["s" /* NavController */], __WEBPACK_IMPORTED_MODULE_15__providers_app__["a" /* CoreAppProvider */]])
    ], AddonCalendarNewPage);
    return AddonCalendarNewPage;
}());

//# sourceMappingURL=newcalendar.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_angular_calendar__ = __webpack_require__(415);
...
var CustomDateFormatter = /** @class */ (function (_super) {
    ...
    CustomDateFormatter.prototype.monthViewColumnHeader = function (_a) {
        ...
        return new __WEBPACK_IMPORTED_MODULE_1__angular_common__["d" /* DatePipe */](locale).transform(date, 'EEE', locale);
    };
    CustomDateFormatter.prototype.monthViewTitle = function (_a) {
        var date = _a.date, locale = _a.locale;
        return new __WEBPACK_IMPORTED_MODULE_1__angular_common__["d" /* DatePipe */](locale).transform(date, 'MMM y', locale);
    };
    ...
    CustomDateFormatter.prototype.dayViewHour = function (_a) {
        var date = _a.date, locale = _a.locale;
        return new __WEBPACK_IMPORTED_MODULE_1__angular_common__["d" /* DatePipe */](locale).transform(date, 'HH:mm', locale);
    };
    return CustomDateFormatter;
}(__WEBPACK_IMPORTED_MODULE_0_angular_calendar__["a" /* CalendarDateFormatter */]));

//# sourceMappingURL=customise-date-formats.js.map
...
}(__WEBPACK_IMPORTED_MODULE_0_angular_calendar__["b" /* CalendarEventTitleFormatter */]));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_tslib__ = __webpack_require__(94);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_BehaviorSubject__ = __webpack_require__(423);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_rxjs_observable_of__ = __webpack_require__(287);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_rxjs_operator_concatMap__ = __webpack_require__(421);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_rxjs_operator_map__ = __webpack_require__(286);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_rxjs_operator_mergeMap__ = __webpack_require__(998);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_rxjs_observable_from__ = __webpack_require__(420);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_rxjs_operator_catch__ = __webpack_require__(992);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_rxjs_operator_concatAll__ = __webpack_require__(993);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13_rxjs_operator_first__ = __webpack_require__(994);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14_rxjs_util_EmptyError__ = __webpack_require__(220);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15_rxjs_observable_fromPromise__ = __webpack_require__(419);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16_rxjs_operator_every__ = __webpack_require__(996);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17_rxjs_operator_last__ = __webpack_require__(995);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18_rxjs_operator_mergeAll__ = __webpack_require__(997);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19_rxjs_operator_reduce__ = __webpack_require__(999);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__angular_platform_browser__ = __webpack_require__(83);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21_rxjs_operator_filter__ = __webpack_require__(422);
...
function copyConfig(r) {
    ...
    return children ? Object(__WEBPACK_IMPORTED_MODULE_2_tslib__["a" /* __assign */])({}, r, { children: children }) : Object(__WEBPACK_IMPORTED_MODULE_2_tslib__["a" /* __assign */])({}, r);
}
...
function wrapIntoObservable(value) {
    if (Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["_38" /* ɵisObservable */])(value)) {
        return value;
    }
    if (Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["_39" /* ɵisPromise */])(value)) {
...
var Router = /** @class */ (function () {
    ...
    function (commands, navigationExtras) {
        ...
        if (Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["_20" /* isDevMode */])() && preserveQueryParams && /** @type {?} */ (console) && /** @type {?} */ (console.warn)) {
...
var RouterLink = /** @class */ (function () {
    ...
    Object.defineProperty(RouterLink.prototype, "preserveQueryParams", {
         ...
         */
        function (value) {
            if (Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["_20" /* isDevMode */])() && /** @type {?} */ (console) && /** @type {?} */ (console.warn)) {
                console.warn('preserveQueryParams is deprecated!, use queryParamsHandling instead.');
            }
            this.preserve = value;
        },
...
var RouterLinkWithHref = /** @class */ (function () {
    ...
    RouterLinkWithHref.ctorParameters = function () { return [
        { type: Router, },
        { type: ActivatedRoute, },
        { type: __WEBPACK_IMPORTED_MODULE_0__angular_common__["h" /* LocationStrategy */], },
    ]; };
...
var ROUTER_PROVIDERS = [
    __WEBPACK_IMPORTED_MODULE_0__angular_common__["g" /* Location */],
    { provide: UrlSerializer, useClass: DefaultUrlSerializer },
    {
        provide: Router,
        useFactory: setupRouter,
        deps: [
            __WEBPACK_IMPORTED_MODULE_1__angular_core__["g" /* ApplicationRef */], UrlSerializer, ChildrenOutletContexts, __WEBPACK_IMPORTED_MODULE_0__angular_common__["g" /* Location */], __WEBPACK_IMPORTED_MODULE_1__angular_core__["D" /* Injector */],
    ...
    { provide: __WEBPACK_IMPORTED_MODULE_1__angular_core__["L" /* NgModuleFactoryLoader */], useClass: __WEBPACK_IMPORTED_MODULE_1__angular_core__["_6" /* SystemJsNgModuleLoader */] },
    RouterPreloader,
    NoPreloading,
    PreloadAllModules,
        ...
        return {
            ...
            providers: [
                ...
                provideRoutes(routes),
                {
                    ...
                    deps: [[Router, new __WEBPACK_IMPORTED_MODULE_1__angular_core__["P" /* Optional */](), new __WEBPACK_IMPORTED_MODULE_1__angular_core__["_5" /* SkipSelf */]()]]
                },
                { provide: ROUTER_CONFIGURATION, useValue: config ? config : {} },
                {
                    ...
                    deps: [
                        __WEBPACK_IMPORTED_MODULE_0__angular_common__["j" /* PlatformLocation */], [new __WEBPACK_IMPORTED_MODULE_1__angular_core__["A" /* Inject */](__WEBPACK_IMPORTED_MODULE_0__angular_common__["a" /* APP_BASE_HREF */]), new __WEBPACK_IMPORTED_MODULE_1__angular_core__["P" /* Optional */]()], ROUTER_CONFIGURATION
                    ]
                },
                {
...
function provideLocationStrategy(platformLocationStrategy, baseHref, options) {
    ...
    return options.useHash ? new __WEBPACK_IMPORTED_MODULE_0__angular_common__["e" /* HashLocationStrategy */](platformLocationStrategy, baseHref) :
        new __WEBPACK_IMPORTED_MODULE_0__angular_common__["i" /* PathLocationStrategy */](platformLocationStrategy, baseHref);
}
/**
 * @param {?} router
 * @return {?}
...
function setupRouter(ref, urlSerializer, contexts, location, injector, loader, compiler, config, opts, urlHandlingStrategy, routeReuseStrategy) {
    ...
    if (opts.enableTracing) {
        var /** @type {?} */ dom_1 = Object(__WEBPACK_IMPORTED_MODULE_20__angular_platform_browser__["i" /* ɵgetDOM */])();
...
var RouterInitializer = /** @class */ (function () {
    ...
    function () {
        var _this = this;
        var /** @type {?} */ p = this.injector.get(__WEBPACK_IMPORTED_MODULE_0__angular_common__["f" /* LOCATION_INITIALIZED */], Promise.resolve(null));
 ...
 * \@stable
 */
var VERSION = new __WEBPACK_IMPORTED_MODULE_1__angular_core__["_11" /* Version */]('5.2.11');
